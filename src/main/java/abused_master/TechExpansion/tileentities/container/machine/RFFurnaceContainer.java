 ...
 */
public class RFFurnaceContainer extends Container {

    IInventory TileRFFurnace;

    public RFFurnaceContainer(InventoryPlayer playerInv, IInventory furnaceInv) {
        super();

        addSlotToContainer(new Slot(furnaceInv, 0, 56, 26));
        addSlotToContainer(new SlotFurnaceOutput(playerInv.player, furnaceInv, 1, 116, 26));
