 ...
 */
public class TileElectrumEnergyBank extends TileEntity implements IEnergyReceiver, IEnergyProvider, ITickable {

    protected EnergyStorage storage = new EnergyStorage(600000);
    ...
    public int extractEnergy(EnumFacing from, int maxExtract, boolean simulate) {
        return storage.extractEnergy(maxExtract = 16000, simulate);
    }
    @Override
