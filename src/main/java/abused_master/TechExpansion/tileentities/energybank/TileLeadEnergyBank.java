 ...
 */
public class TileLeadEnergyBank extends TileEntity implements IEnergyReceiver, IEnergyProvider, ITickable {
    ...
    public int extractEnergy(EnumFacing from, int maxExtract, boolean simulate) {
        return storage.extractEnergy(maxExtract = 8000, simulate);
    }
